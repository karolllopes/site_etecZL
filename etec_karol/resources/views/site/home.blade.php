...
<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
  ...
  <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <img src="{{ asset('img/home_carrosel1.jpg') }}" class="d-block w-100" alt="Slide 1" width="1000" height="500">
        <div class="container">
          <div class="carousel-caption text-start">
            ...
            <p> Excelência em Educação Técnica na Região da Zona Leste de São Paulo. </p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
      <img src="{{ asset('img/home_carrosel2.jpeg') }}" class="d-block w-100" alt="Slide 2" width="1000" height="500">
        <div class="container">
      ...
      <div class="carousel-item">
      <img src="{{ asset('img/home_carrosel3.jpeg') }}" class="d-block w-100" alt="Slide 3"  width="1000" height="500">
        <div class="container">
          <div class="carousel-caption">
